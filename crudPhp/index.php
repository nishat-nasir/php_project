...
<body class="bg-light">
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-5">
            ...
            <!-- add data -->
            <div class="card-body">
                <h3 class="card-title">Add Data Students</h3>
        ...
        <div class="table-responsive mb-5 card">
            ...
            $data = mysqli_query($db, "SELECT * FROM students");
            $jumlah_data = mysqli_num_rows($data);
            $total_halaman = ceil($jumlah_data / $batas);

            $data_mhs = mysqli_query($db, "SELECT * FROM students LIMIT $halaman_awal, $batas");
            $no = $halaman_awal + 1;
            ...
            while ($students = mysqli_fetch_array($data_mhs)) {
                echo "<tr>";
                echo "<td style='display:none'>" . $students['id'] . "</td>";
                echo "<td class='text-center'>" . $no++ . "</td>";
                echo "<td>" . $students['nama'] . "</td>";
                echo "<td>" . $students['NIM'] . "</td>";
                echo "<td>" . $students['jenis_kelamin'] . "</td>";
                echo "<td>" . $students['jurusan'] . "</td>";
                echo "<td>" . $students['agama'] . "</td>";
                echo "<td>" . $students['IPK'] . "</td>";
